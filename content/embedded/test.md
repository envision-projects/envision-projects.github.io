...
#include <Stepper.h>
#define STEPS 200
Stepper stepper(STEPS, 32, 25, 33, 26);
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            if (output26State == "open") {
              ...
              client.println("<p><a href=\"/26/off\"><button class=\"button button2\">BACKWARD</button></a></p>");
            }
            ...
            // If the output27State is off, it displays the ON button
            if (output27State == "off") {
              client.println("<p><a href=\"/27/on\"><button class=\"button\">FORWARD(2X)</button></a></p>");
            } else {
              client.println("<p><a href=\"/27/off\"><button class=\"button button2\">BACKWARD(2X)</button></a></p>");
            }
            client.println("</body></html>");
